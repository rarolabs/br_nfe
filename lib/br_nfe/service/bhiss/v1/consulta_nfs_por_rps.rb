module BrNfe
	module Service
		module Bhiss
			module V1
				class ConsultaNfsPorRps < BrNfe::Service::Bhiss::V1::Base
				...
				private
					...
					def set_response
						@response = BrNfe::Service::Response::Build::ConsultaNfsPorRps.new(
							...
							body_xml_path:        [:consultar_nfse_por_rps_response, :output_xml],
							xml_encode:           response_encoding, # Codificação do xml de resposta
							#//Envelope/Body/ConsultarLoteRpsEnvioResponse/ConsultarLoteRpsResposta
							nfe_xml_path:         '//*/*/*/*',
							invoices_path:        [:consultar_nfse_rps_resposta, :comp_nfse],
